...
module.exports = "<div class='optContainer' [ngStyle]=\"{'left': left, 'top': top}\">\n    <div class='opt' (click)='test(\"add apointment\")'>Add apointment</div>\n    <div class='opt' (click)='test(\"add note\")'>Add note</div>\n    <div class='opt' (click)='test(\"cancel\")'>Cancel</div>\n</div>"
...
module.exports = ":host .optContainer {\n  position: absolute;\n  display: block;\n  text-align: center;\n  width: 300px;\n  border: solid #f29f55 2px;\n  background-color: white;\n  cursor: pointer; }\n  :host .optContainer .opt:hover {\n    background: #9d9d9d; }\n"
...
var DayOptionsComponent = /** @class */ (function () {
    function DayOptionsComponent(popupService) {
        this.popupService = popupService;
        this.dayNo = this.popupService.parameter;
    }
    DayOptionsComponent.prototype.test = function (test) {
...
var MonthDayComponent = /** @class */ (function () {
    ...
    MonthDayComponent.prototype.onClick = function (event) {
        var target = event;
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["y" /* HostListener */])('click', ['$event']),
        __metadata("design:type", Function),
